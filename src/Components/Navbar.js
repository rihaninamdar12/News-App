...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg bg-dark position-sticky z-1 top-0 start-0">
                <div className="container-fluid">
                    <Link className="navbar-brand text-light" to="/home">Get<span className='text-danger'>News</span></Link>
